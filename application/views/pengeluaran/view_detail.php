		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('barang') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<?php if ($this->session->login['role'] == 'admin'): ?>
							<a href="<?= base_url('pengeluaran/export_detail_pengeluaran').$report_filter ?>" target="_blank" class="btn btn-danger btn-sm"><i class="fa fa-print"></i>&nbsp;&nbsp;Export</a>
				...
				<div class="card shadow">
					<div class="card-header"><strong>Daftar Barang Pengeluaran</strong></div>
					<div class="card-body">
								...
								<tbody>
									<?php foreach ($all_pengeluaran as $pengeluaran): ?>
										<tr>
											...
											<td><?= $pengeluaran->jumlah ?> <?= strtoupper($pengeluaran->satuan) ?></td>
										</tr>
									<?php endforeach ?>
								</tbody>
							</table>
