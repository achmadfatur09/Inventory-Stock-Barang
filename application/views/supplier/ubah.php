								...
								<form action="<?= base_url('supplier/proses_ubah/' . $supplier->kode) ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode" placeholder="Masukkan Kode Distributor" autocomplete="off"  class="form-control" required value="<?= $supplier->kode ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
											<label for="nama"><strong>Nama Distributor</strong></label>
											<input type="text" name="nama" placeholder="Masukkan Nama Distributor" autocomplete="off"  class="form-control" required value="<?= $supplier->nama ?>">
										</div>
									</div>
									<div class="form-row">
