								...
								<form action="<?= base_url('supplier/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode" placeholder="Masukkan Kode" autocomplete="off"  class="form-control" required value="Distributor-<?= mt_rand(10, 99) ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
											<label for="nama"><strong>Nama Distributor</strong></label>
											<input type="text" name="nama" placeholder="Masukkan Nama Distributor" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<div class="form-row">
