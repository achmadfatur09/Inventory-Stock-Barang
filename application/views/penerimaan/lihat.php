			...
			<div id="content" data-url="<?= base_url('penerimaan') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<a href="<?= base_url('penerimaan/view_detail') ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Detail</a>
			...
			<div class="modal fade" id="modalExport" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog " role="document">
					<div class="modal-content">
						...
						<form action="<?= base_url('penerimaan/export') ?>" method="post" target="_blank">
