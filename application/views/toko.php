						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('toko/proses_ubah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-group">
										<label for="nama_toko"><strong>Nama Owner : </strong></label>
									...
									<div class="form-group">
										<label for="nama_toko"><strong>No Telepon dan WhatsApp : </strong></label>
