...
class Supplier extends CI_Controller{
	...
	public function index(){
		$this->data['title'] = 'Data Distributor';
	...
	public function proses_tambah(){
		...
		if($this->m_supplier->tambah($data)){
			$this->session->set_flashdata('success', 'Data Distributor <strong>Berhasil</strong> Ditambahkan!');
			redirect('supplier');
		} else {
			$this->session->set_flashdata('error', 'Data Distributor <strong>Gagal</strong> Ditambahkan!');
			redirect('supplier');
		}
	}
	...
	public function ubah($kode){
		...
		$this->data['title'] = 'Ubah Distributor';
	...
	public function proses_ubah($kode){
		...
		if($this->m_supplier->ubah($data, $kode)){
			$this->session->set_flashdata('success', 'Data Distributor <strong>Berhasil</strong> Diubah!');
			redirect('supplier');
		} else {
			$this->session->set_flashdata('error', 'Data Distributor <strong>Gagal</strong> Diubah!');
			redirect('supplier');
		}
	}
	...
	public function hapus($kode){
		...
		if($this->m_supplier->hapus($kode)){
			$this->session->set_flashdata('success', 'Data Distributor <strong>Berhasil</strong> Dihapus!');
			redirect('supplier');
		} else {
			$this->session->set_flashdata('error', 'Data Distributor <strong>Gagal</strong> Dihapus!');
			redirect('supplier');
		}
	}
